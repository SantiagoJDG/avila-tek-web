...
export const IntegrationTools = () => { 
    ...
    return (
        <>
            <div className="flex flex-col items-center gap-4 m-10 w-full">
                    <p className="text-3xl font-bold text-center">
                        Get more value from your tools
                    </p>
                    <p className="text-center text-sm sm:text-base md:text-lg text-gray-700 px-4 md:w-full lg:w-2/5 xl:w-2/3">
            ...
            <div className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 gap-3'>
                {tools.map((tool, index) => (
                    <div className='flex flex-col items-center justify-center gap-5 p-4' key={index}>
                        ...
                        <p className='text-center text-sm sm:text-base md:text-lg text-gray-500 px-4'>
                            {tool.description}
                        </p>
